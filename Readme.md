...
* Студент: [Татьяна Басараб](https://up.htmlacademy.ru/htmlcss/26/user/910923).
* Наставник: `Неи11123звестно`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/910923-technomart-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
